...
<div id="tools">
    <div id="tools_crop" style="display:none;">
        <div id="tool_inputs">
            ...
            <label for="cw">Breite:</label><input type="text" id="cw" class="textInput" onchange="updateMarker('crop')"/>
            <label for="ch">Höhe:</label><input type="text" id="ch" class="textInput" onchange="updateMarker('crop')"/>
        ...
        <a href="javascript: editor.reset();" class="buttons" title="Cancel"><img src="img/btn_cancel.gif" height="30" width="30" alt="Abbrechen" /></a>        
    </div>  
    <div id="tools_scale" style="display:none;">
        <div id="tool_inputs">
            ...
            <label for="constProp">Seitenverhältnis verankern</label>
            <img src="img/div.gif" height="30" width="2" class="div" alt="|" />
        </div>  
        <a href="javascript: editor.doSubmit('scale');" class="buttons" title="Ok"><img src="img/btn_ok.gif" height="30" width="30" alt="Ok" /></a>
        <a href="javascript: editor.reset();" class="buttons" title="Abbrechen"><img src="img/btn_cancel.gif" height="30" width="30" alt="Abbrechen" /></a>     
    </div>  
