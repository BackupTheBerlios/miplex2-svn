...
settings.basesettings.keywords=Schl�sselw�rter
...
settings.user.delete=Benutzer l�schen
...
settings.group.delete=Benutzergruppe löschen
...
settings.right.delete=Recht löschen
