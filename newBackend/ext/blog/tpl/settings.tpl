<h2>Einstellungen</h2>
Hie werden alle Einstellungen f�r das Blog gemacht
<form action="{$url}" method="POST">
    <table>
        ...
        <tr>
            <td>Anzahl der Eintr�ge auf der Startseite:</td>
            <td><input type="text" name="blog[params][countDisplay]"  value="{$params.countDisplay}"/></td>
        </tr>   
        <tr>
            <td>Anzahl der Kommentare f�r Sticky-Eintrag:</td>
        ...
        <tr>
            <td>Template f�r die Einträge</td>
            <td>
        ...
        <tr>
            <td>Template f�r die Kommentare</td>
            <td>
        ...
        <tr>
            <td>Template f�r die Hauptansicht</td>
            <td>
