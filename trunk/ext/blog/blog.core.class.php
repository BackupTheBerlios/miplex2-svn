...
/*
  ...
  Nimmt einen String auf und entfernt daraus das umschlie�ende CDATA Tag
  
  bool checkDate() - �berpr�ft einen String, ob es ein korrektes Datum ist
  ...
  array getEtnryByNumberOrContext() - Liefert alle Eintr�ge passend zu genau einer Nummer oder Kontext

  array getEntry() - Liefert alle Eintr�g z.B. ab einem Startwert und eine bestimmte Anzahl
  ...
  bool addEntry() - Einen Eintrag zinzuf�gen

  bool addComment() - Ein Kommentar hinzuf�gen
...
*/
    ...
    class weblog
    {
        ...
        /**
        * Funktion pr�ft Datum auf korrekte Eingabe
        ...
        */
        ...
        /**
        * Alle Eintr�ge von bis
        * @param date $von Startdatum
        * @param date $bis="" Enddatum standardm��ig leer
        * @return array $dateEntries Die passenden Eintr�ge zur Abfrage
        */
        ...
        /**
        * Gibt eintrag mit bestimmter Nummer Zur�ck
        * Sinnvoll w�re eine alternative �bergabe des passenden Kontextes
        ...
        */
        function getEntryByNumberOrContext($number)
        {
           if (is_numeric($number))
           {
        	...
        	if (!empty($evalContext))
        	{
                ...
                //Nun alle Kommentare hintenanh�ngen
        ...
        /**
        * Gibt anzahl von Eintr�gen zur�ck
        * @param int count = -1 --> alle Eintr�ge
        * @param int count = int --> Anzahl der Eintr�ge
        * @param int start --> Startwert
        *
        * Wenn count von start l�nger als Array, wird bis ende gemacht
        */
        function getEntry( $start=0 , $count=-1)
        {
            ...
            
            {
                //Wenn alle angezeigt werden sollen, dann anzahl bestimmen
            	  ...
            	  //Wenn count gr��er als Anzahl, dann auf das richtige begrenzen
                ...
                for ($i = $start; $i < $count ; $i++)
                {
                    ...
                    //Alle Ausgeben, die ben�tigt ==> Achtung Problem mit 0 und 1 Start des Arrays
        ...
        /**
      	...
      	* TODO �berp�fen der Position der Kommentare
      	...
      	*/
      	function addComment($numberOfEntry, $commentArray)
      	{
      		...
      		if ((is_array($commentArray)))
      		{
      			...
      			{
                    //Neuen Kommentar ganz hinten anf�gen
  	    ...
  	    /**
  	    * Funktion zum hinzuf�gen von Eintr�gen in das Blog
  	    ...
  	    */
  	    ...
  	    /**
  	    * Dies Funktion gibt zu den Einr�gen alle verwendeten Kategorien zur�ck
  	    * Funktionalit�t ist fraglich, da ja nict alle Kategorien benutzt werden m�ssen
  	    */
  	    ...
  	    /**
        * Diese Funktion gibt zum �bergenen Namen der kategorie die passenden Eintr�ge im Weblog zur�k
        * @param string $catName Der Name der gesuchten Kategorie
        * @return array catEntries Die gefundenn Eintr�ge im Weblog
        */
        ...
        */
        ...
        /**
        * Gibt die letzten x Eintr�ge des Weblogs aus
        ...
        */
        ...
        /**
        * Funktion verschickt nach einem Kommentar wenn gew�nscht eine Mail
        *
        */
