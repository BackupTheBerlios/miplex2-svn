...
<html>
	...
	<body onload="Init();">
    	<form action='' method='post' name='form1' id ='form1' >
          <p class='title'>Bitte auswählen:</p>
          ...
          <p><button type="button" name="cancel" onclick="return onCancel();">Cancel</button>
		  <button type="button" name="ok" onclick="return onOKi();">Ok</button></p>
