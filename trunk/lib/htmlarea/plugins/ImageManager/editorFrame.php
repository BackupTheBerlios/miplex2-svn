...
<? if ($editor->isGDEditable() == -1) { ?>
    <div style="text-align:center; padding:10px;"><span class="error">Das GIF format wird leider nicht vollständig unterstützt.</span></div>
<? } ?>
...
<? } else { ?>
    <span class="error">Kein Bild verfügbar.</span>
<? } ?>
        </td>
    </tr>
</table>
