...
*/
//$MY_DOCUMENT_ROOT = 'C:\xampp5\htdocs\miplex2\files';
$MY_DOCUMENT_ROOT = $oConfig->fileSystemRoot."files";
//$MY_DOCUMENT_ROOT = '/home/www/alrashid.klokan.sk/insFile/data';
...
*/
//$MY_URL_TO_OPEN_FILE 	= 'http://localhost/miplex2/files';
$MY_URL_TO_OPEN_FILE 	= $oConfig->server.$oConfig->docroot."files";
